...
Texture dadoTextureOp;

Model Kitt_M;
Model Llanta_M;
Model Dado_M;
Model Dado_texturizado;
...
// average normals
	GLfloat cubo_vertices[] = {
		...
		// right
		//x		y		z		S		T
		0.5f, -0.5f,  0.5f,	    0.5f,  0.01f,		-1.0f,	0.0f,	0.0f,
		0.5f, -0.5f,  -0.5f,	0.75f,	0.01f,		-1.0f,	0.0f,	0.0f,
...
int main()
{
	...
	dadoTexture = Texture("Textures/dado_animales_optimizado.png");
	dadoTexture.LoadTextureA();
	logofiTexture = Texture("Textures/escudo_fi_color.tga");
	logofiTexture.LoadTextureA();
	dadoTextureOp = Texture("Textures/dado_animales_optimizado.png");
	dadoTextureOp.LoadTextureA();
	...
	Dado_texturizado = Model();
	Dado_texturizado.LoadModel("Models/cubo_texturizado.obj");
