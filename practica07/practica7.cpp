...
int main()
{
	...
	pointLights[1] = PointLight(1.0f, 1.0f, 1.0f,  //color blanco
		0.5f, 1.0f,                                
		3.0f, 0.0f, -13.0f,                       //posición
		0.3f, 0.1f, 0.1f);                       
	pointLightCount++;

	//luz para helicoptero
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//actualizar posición de la luz del faro para que siga al coche
		glm::vec3 movimientoCarro = glm::vec3(0.0f + mainWindow.getmover(), -2.0f, -2.0f);
		spotLights[2].SetFlash(
			movimientoCarro + glm::vec3(0.0f, 0.5f, 0.0f),  
			glm::vec3(-1.0f, 0.0f, 0.0f)                
		);

		glm::vec3 movimientoHelicoptero = glm::vec3(0.0f + mainWindow.getmoverHelicoptero(), 5.0f, 6.0f);
		spotLights[1].SetFlash(
			movimientoHelicoptero + glm::vec3(0.0f, -0.5f, 0.0f),
		...
		//Movimiento de helicoptero con K y L
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(mainWindow.getmoverHelicoptero(), 5.0f, 6.0));
