...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Limpiar la ventana
		glClearColor(0.234f, 0.453f, 0.764f, 1.0f);
...
/*
		...
		modelaux = model; //recordar que limpia de alguna manera el model.
		...
		//articulacion llanta posterior derecha (letra K)
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.8f, -1.4f, -0.2f));
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.5f, 1.0f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();

		model = modelaux;

		//articulacion posterior izquierda (letra l)
		...
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(1.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		color = glm::vec3(1.0f, 1.5f, 1.5f);
		glUniform3fv(uniformColor, 1, glm::value_ptr(color));
		meshList[2]->RenderMeshGeometry();

		model = modelaux;

		//articulacion llanta frontal derecha (letra Z)
		modelaux = model;
		model = glm::translate(model, glm::vec3(0.8f, -1.4f, 0.2f));
		...
		//articulacion llanta frontal izquierda (letra X)
		modelaux = model;
		model = glm::translate(model, glm::vec3(-0.8f, -1.4f, 0.2f));
...
//AQUÍ EMPIEZA EL GATO
		model = glm::mat4(1.0);

		//Cuerpo
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));//origen
		...
		model = glm::scale(model, glm::vec3(3.0f, 1.3f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();
		model = modelaux;
		...
		model = glm::scale(model, glm::vec3(1.0f, 3.5f, 0.8f));
		...
		//PATAS
		modelaux = model;
		model = glm::translate(model, glm::vec3(-2.0f, -1.5f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion5()), glm::vec3(0.0f, 0.0f, 1.0f));
		
		//pata derecha letra K
		model = glm::scale(model, glm::vec3(1.0f, 2.5f, 0.8f));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		meshList[0]->RenderMesh();
		...
		//patas traseras
		//pata trasera derecha (letra C)
		modelaux = model;
		model = glm::translate(model, glm::vec3(4.0f, -0.8f, 0.8f));
		...
		//oreja derecha lletra g
		modelaux = model;
		model = glm::translate(model, glm::vec3(-0.5f, 2.5f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getarticulacion2()), glm::vec3(0.0f, 0.0f, 1.0f));
		
		
		//cono
		model = glm::scale(model, glm::vec3(0.5f, 0.8f, 0.3f));
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
