...
void CrearOctaedro()
{
	// Índices de los triángulos del octaedro
	...
	GLfloat octaedro_vertices[] = {
		//caras superiores
		0.0f,  0.5f,  0.0f,  0.01f,  0.25f,   0.0f,  1.0f,  1.0f,  
		0.0f,  0.0f,  0.5f,  0.5f,  0.25f,   0.0f,  0.5f,  1.0f,  
		0.5f,  0.0f,  0.0f,  0.25f,  0.5f,   1.0f,  0.5f,  0.0f,  

	
		0.0f,  0.5f,  0.0f,  0.5f,  0.75f,   0.0f,  1.0f,  1.0f,  
		0.0f,  0.0f,  0.5f,  0.75f,  0.5f,   0.0f,  0.5f,  1.0f,  
	   -0.5f,  0.0f,  0.0f,  0.25f,  0.5f,  -1.0f,  0.5f,  0.0f, 

	   
	   0.0f,  0.5f,  0.0f,  0.05f,  0.72f,   0.0f,  1.0f, -1.0f,  
	   0.5f,  0.0f,  0.0f,  0.26f,  0.48f,   1.0f,  0.5f,  0.0f,  
	   0.0f,  0.0f, -0.5f,  0.5f,  0.72f,   0.0f,  0.5f, -1.0f,  

	   0.0f,  0.5f,  0.0f,  0.5f,  0.25f,   0.0f,  1.0f, -1.0f,   // 0.25
	  -0.5f,  0.0f,  0.0f,  0.25f,  0.5f,  -1.0f,  0.5f,  0.0f,  
	   0.0f,  0.0f, -0.5f,  0.75f,  0.5f,   0.0f,  0.5f, -1.0f,

	 //caras inferiores
	   0.0f, -0.5f,  0.0f,  0.97f,  0.25f,   0.0f, -1.0f,  1.0f,  
	   0.0f,  0.0f,  0.5f,  0.5f,  0.23f,   0.0f, -0.5f,  1.0f,  
	   0.5f,  0.0f,  0.0f,  0.75f,  0.48f,   1.0f, -0.5f,  0.0f,  

	  
	   0.0f, -0.5f,  0.0f,  0.75f,  0.98f,   0.0f, -1.0f,  1.0f,  
	   0.0f,  0.0f,  0.5f,  0.5f,  0.75f,   0.0f, -0.5f,  1.0f,  
	  -0.5f,  0.0f,  0.0f,  0.97f,  0.75f,  -1.0f, -0.5f,  0.0f,  

	 
	  0.0f, -0.5f,  0.0f,  0.96f,  0.75f,   0.0f, -1.0f, -1.0f,  
	  0.5f,  0.0f,  0.0f,  0.73f,  0.5f,   1.0f, -0.5f,  0.0f,  
	  0.0f,  0.0f, -0.5f,  0.5f,  0.75f,   0.0f, -0.5f, -1.0f,  

	  0.0f, -0.5f,  0.0f,  0.73f,  0.01f,   0.0f, -1.0f, -1.0f,  
	 -0.5f,  0.0f,  0.0f,  0.95f,  0.25f,  -1.0f, -0.5f,  0.0f, 
	  0.0f,  0.0f, -0.5f,  0.5f,  0.25f,   0.0f, -0.5f, -1.0f  
	};
...
int main()
{
	...
	dado8Texture = Texture("Textures/dado_8_caras_optimizado.png");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));		//dado 8 caras
		...
		color = glm::vec3(0.0f, 0.0f, 1.0f);//color llantas
