...
int main()
{
	...
	llanta_frontal_1.LoadModel("Models/llanta_frontal_1.obj");
	llanta_frontal_2 = Model();
	llanta_frontal_2.LoadModel("Models/llanta_frontal_2.obj");
	llanta_posterior_1 = Model();
	llanta_posterior_1.LoadModel("Models/llanta_posterior_1.obj");
	llanta_posterior_2 = Model();
	llanta_posterior_2.LoadModel("Models/llanta_posterior_2.obj");
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//Goddard
		color = glm::vec3(0.0f, 0.7f, 0.9f); //modelo de goddard de color negro
		...
		model = glm::translate(model, glm::vec3(-28.0f, 31.0f, -0.0f));
